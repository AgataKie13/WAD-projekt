...
###### Propozycja obliczania i wyświetlania statystyk "Najczęstszych" dla zmiennych kategorycznych
...
TU TRZEBABY DODAĆ JESZCZE FAKTYCZNY OPIS TYCH STATYSTYK (CHYBA)
:::
...
# 4. Obróbka zmiennych
## 3.1. Tworzenie nowych zmiennych
:::  {style="text-align: justify;"}
...
### 4.1.1. Sprawdzenie założeń analizy PCA
...
### 4.1.2. Określenie liczby składowych do redukcji
...
##@ 4.1.3. Interpretacja wyników PCA
...
### 4.2.1. Określanie optymalnej liczby skupień
...
### 4.2.2. Właściwa analiza *k-means*
...
### 4.2.3. Analiza centrów klastrów
...
### 4.2.4. Przypisanie obserwacji do klastrów
...
### 4.2.5. Wizualizacja wyników segmentacji
...
# 5. PORÓWNANIE METOD I WIZUALIZACJA WYNIKÓW
