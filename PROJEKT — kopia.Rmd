...
:::
::: {style="text-align:justify;"}
Analiza wykresów rozkładów zmiennych liczbowych i kategorycznych pozwoliła poznać strukturę danych i zidentyfikować obserwacje odstające. W zmiennych liczbowych dominują niskie wartości, a niektóre, jak *czas_wyprzedzenia_rezerwacji* czy *liczba_nocy_tygodniowych*, wykazują wyraźne kształty rozkładu.
Wśród zmiennych kategorycznych największe różnice w udziale odwołań występują w *rodzaj_depozytu*, *segment_rynku*, *kanał_dystrybucji* i *typ_klienta*, natomiast *rodzaj_wyżywienia*, *typ_hotelu* oraz zmienne czasowe mogą pełnić rolę wspomagającą. 
Wnioski z wykresów wskazują, które cechy warto uwzględnić w dalszej analizie *odwołania_rezerwacji*.
::::
