...
#➡ usuń liczba_dorosłych, liczba_dzieci, liczba_niemowląt
...
nowe_zmienne <- c("zmiana_pokoju", "liczba_nocy")
...
# Dodanie nowej zmiennej do wektora zmeinne_ilosciowe
...
zmienne_kategoryczne <- zmienne_kategoryczne %>%
  setdiff(c("rok_przyjazdu", "dzień_przyjazdu_w_miesiącu"))
